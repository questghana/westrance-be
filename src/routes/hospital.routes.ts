import { ActiveDeactiveHospitalEmployee, SearchPatientById, addHospitalDependentController, addHospitalEmployeeController, addHospitalEmployeeRoleManagement, addInvoice, deleteHospitalEmployee, deleteInvoice, editHospitalEmployee, getHospitalDepartment, getHospitalEmployees, getHospitalEmployeesWithDependents, getInvoiceByHospital, getPatientByNameAndId, getMonthlyPatientVisits, getHospitalDashboardStats } from "@/controllers/hospital.controller";
